...
The pipeline of DENAGA is similar to other EDAs and incorporates techniques from HBOA \cite{hboa}. An initial population of solutions is drawn from a uniform distribution. These solutions are evaluated and the fittest unique x\% are selected (i.e. truncation selection) to be the training set, \(T\). 
